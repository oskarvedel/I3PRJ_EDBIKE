...
{
    uint8 staticBits = (LED_pin_DR & (uint8)(~LED_pin_MASK));
    LED_pin_DR = staticBits | ((uint8)(value << LED_pin_SHIFT) & LED_pin_MASK);
}
...
{
	CyPins_SetPinDriveMode(LED_pin_0, mode);
}
...
{
    return (LED_pin_PS & LED_pin_MASK) >> LED_pin_SHIFT;
}
...
{
    return (LED_pin_DR & LED_pin_MASK) >> LED_pin_SHIFT;
}
...
/* If interrupt is connected for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
		if((position & LED_pin_0_INTR) != 0u) 
		{ 
			 LED_pin_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (LED_pin_INTSTAT & LED_pin_MASK) >> LED_pin_SHIFT;
    }
