...
// SPI_Slave_v2_70(BidirectMode=false, ClockInternal=true, ControlFileName=SPI_Slave_Default.ctl, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CyGetRegReplacementString_1=CY_GET_REG8, CyGetRegReplacementString_2=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DesiredBitRate=1000000, FixedPlacementEnabled=false, InternalInterruptEnabled=0, InternalRxInterruptEnabled=0, InternalTxInterruptEnabled=1, InterruptOnByteComplete=false, InterruptOnDone=false, InterruptOnRXEmpty=false, InterruptOnRXFull=true, InterruptOnRXNotEmpty=false, InterruptOnRXOverrun=false, InterruptOnTXEmpty=false, InterruptOnTXFull=false, InterruptOnTXNotFull=true, IntOnByteComp=0, IntOnRXEmpty=0, IntOnRXFull=1, IntOnRXNotEmpty=0, IntOnRXOver=0, IntOnSPIDone=0, IntOnTXEmpty=0, IntOnTXFull=0, IntOnTXNotFull=1, Mode=2, ModeUseZero=0, MultiSlaveEnable=false, NumberOfDataBits=8, PSoC3_ES2_PSoC5_ES1=false, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, RxBufferSize=4, ShiftDir=0, SiliconRevisionReplacementString=es3, TxBufferSize=24, UseInternalInterrupt=false, UseRxInternalInterrupt=false, UseTxInternalInterrupt=true, VerilogSectionReplacementString=sR8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=SPI_Slave_v2_70, CY_CONFIG_TITLE=SPI_slave, CY_CONST_CONFIG=true, CY_CONTROL_FILE=SPI_Slave_Default.ctl, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=SPI_slave, CY_INSTANCE_SHORT_NAME=SPI_slave, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=70, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=SPI_slave, )
...
// Timer_v2_80(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=false, CaptureMode=0, CONTROL3=0, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeviceFamily=PSoC5, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, HWCaptureCounterEnabled=false, InterruptOnCapture=false, InterruptOnFIFOFull=false, InterruptOnTC=true, IntOnCapture=0, IntOnFIFOFull=0, IntOnTC=1, NumberOfCaptures=1, param45=1, Period=2999, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UsesHWEnable=0, VerilogSectionReplacementString=sT16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Timer_v2_80, CY_CONFIG_TITLE=WheelTickTimer, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=WheelTickTimer, CY_INSTANCE_SHORT_NAME=WheelTickTimer, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=80, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=WheelTickTimer, )
...
module top ;
    ...
    SPI_Slave_v2_70_0 SPI_slave (
        .mosi(Net_1),
        .sclk(Net_2),
        .ss(Net_3),
        .miso(Net_24),
        .clock(1'b0),
        .tx_interrupt(Net_214),
        .sdat(Net_7),
        .rx_interrupt(Net_30),
        .miso_oe(Net_9),
        .reset(1'b0));
	...
	cy_psoc3_pins_v1_10
		#(.id("45bdd2c6-2308-4431-a854-a9ee9db46b71"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("5bcb3315-d27e-4d29-a1c4-4bba55906c66"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("0da12972-2536-46b1-bf17-6b9fa1e96d9d"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__WheelTickPin_net;
	wire [0:0] tmpIO_0__WheelTickPin_net;
	electrical [0:0] tmpSIOVREF__WheelTickPin_net;

	cy_psoc3_pins_v1_10
		#(.id("c2695c54-d43e-4e15-b0bc-c96e37ecd96e"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		WheelTickPin
		 (.oe(tmpOE__WheelTickPin_net),
		  .y({1'b0}),
		  .fb({Net_309}),
		  .io({tmpIO_0__WheelTickPin_net[0:0]}),
		  .siovref(tmpSIOVREF__WheelTickPin_net),
		  .interrupt({Net_318}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__WheelTickPin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    Timer_v2_80_2 MotorLockTimer (
        ...
        .tc(Net_373),
        .clock(Net_365));
    defparam MotorLockTimer.CaptureCount = 2;
    defparam MotorLockTimer.CaptureCounterEnabled = 0;
    defparam MotorLockTimer.DeviceFamily = "PSoC5";
    defparam MotorLockTimer.InterruptOnCapture = 0;
    defparam MotorLockTimer.InterruptOnTC = 1;
    defparam MotorLockTimer.Resolution = 16;
    defparam MotorLockTimer.SiliconRevision = "0";


	cy_isr_v1_0
		#(.int_type(2'b00))
		Timer_Isr_BikeIsStopping
		 (.int_signal(Net_348));


    Timer_v2_80_3 AccelerometerTimer (
        .reset(Net_356),
        .interrupt(Net_357),
        .enable(1'b1),
        .trigger(1'b1),
        ...
        .tc(Net_362),
        .clock(Net_354));
    defparam AccelerometerTimer.CaptureCount = 2;
    defparam AccelerometerTimer.CaptureCounterEnabled = 0;
    defparam AccelerometerTimer.DeviceFamily = "PSoC5";
    defparam AccelerometerTimer.InterruptOnCapture = 0;
    defparam AccelerometerTimer.InterruptOnTC = 1;
    defparam AccelerometerTimer.Resolution = 24;
    defparam AccelerometerTimer.SiliconRevision = "0";
	...
	wire [0:0] tmpOE__Pin_1_ac_idle_net;
	wire [0:0] tmpIO_0__Pin_1_ac_idle_net;
	electrical [0:0] tmpSIOVREF__Pin_1_ac_idle_net;

	cy_psoc3_pins_v1_10
		#(.id("7b54db96-7ce2-491a-b6b3-c012db053e43"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_1_ac_idle
		 (.oe(tmpOE__Pin_1_ac_idle_net),
		  .y({1'b0}),
		  .fb({Net_308}),
		  .io({tmpIO_0__Pin_1_ac_idle_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_1_ac_idle_net),
		  .interrupt({Net_23}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_1_ac_idle_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_2_ac_moving_net;
	wire [0:0] tmpIO_0__Pin_2_ac_moving_net;
	electrical [0:0] tmpSIOVREF__Pin_2_ac_moving_net;

	cy_psoc3_pins_v1_10
		#(.id("edff8ec0-740e-4ec2-a4a7-2a38b6d7e7f3"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_2_ac_moving
		 (.oe(tmpOE__Pin_2_ac_moving_net),
		  .y({1'b0}),
		  .fb({Net_307}),
		  .io({tmpIO_0__Pin_2_ac_moving_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_2_ac_moving_net),
		  .interrupt({Net_320}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_2_ac_moving_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("9af2e420-c389-4519-9eda-797bbbb4e891"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4668ecd2-ebc5-47c0-a60e-4c4401238257"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__EA_net;
	wire [0:0] tmpFB_0__EA_net;
	wire [0:0] tmpIO_0__EA_net;
	wire [0:0] tmpINTERRUPT_0__EA_net;
	electrical [0:0] tmpSIOVREF__EA_net;

	cy_psoc3_pins_v1_10
		#(.id("a2de89d5-46da-4ee3-8228-110ea93baa35"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		EA
		 (.oe(tmpOE__EA_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__EA_net[0:0]}),
		  .io({tmpIO_0__EA_net[0:0]}),
		  .siovref(tmpSIOVREF__EA_net),
		  .interrupt({tmpINTERRUPT_0__EA_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__EA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    Timer_v2_80_4 WheelTickTimer (
        ...
        .tc(Net_350),
        .clock(Net_325));
    defparam WheelTickTimer.CaptureCount = 2;
    defparam WheelTickTimer.CaptureCounterEnabled = 0;
    defparam WheelTickTimer.DeviceFamily = "PSoC5";
    defparam WheelTickTimer.InterruptOnCapture = 0;
    defparam WheelTickTimer.InterruptOnTC = 1;
    defparam WheelTickTimer.Resolution = 16;
    defparam WheelTickTimer.SiliconRevision = "0";
