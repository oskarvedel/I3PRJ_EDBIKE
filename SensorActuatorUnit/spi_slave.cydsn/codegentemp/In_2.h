...
*/
     ...
     *  @{
     */
        #define In_2_INTR_NONE      (uint16)(0x0000u)
        #define In_2_INTR_RISING    (uint16)(0x0001u)
        #define In_2_INTR_FALLING   (uint16)(0x0002u)
        #define In_2_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define In_2_INTR_MASK      (0x01u) 
#endif /* (In_2__INTSTAT) */
...
/* SIO registers */
#if defined(In_2__SIO_CFG)
    #define In_2_SIO_HYST_EN        (* (reg8 *) In_2__SIO_HYST_EN)
    #define In_2_SIO_REG_HIFREQ     (* (reg8 *) In_2__SIO_REG_HIFREQ)
    #define In_2_SIO_CFG            (* (reg8 *) In_2__SIO_CFG)
    #define In_2_SIO_DIFF           (* (reg8 *) In_2__SIO_DIFF)
#endif /* (In_2__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define In_2_0_INTTYPE_REG 		(* (reg8 *) In_2__0__INTTYPE)
#endif /* (In_2__INTSTAT) */
